...
public class XposedLog667_TXLog {
    private final String TAG = "rtmp.TXLog";
    private final String LOG_METHOD = "com.tencent.rtmp.TXLog";
    ...
    public void findAndPrintLog(XC_LoadPackage.LoadPackageParam loadPackageParam) {
        XposedHelpers.findAndHookMethod(LOG_METHOD, loadPackageParam.classLoader,
                "wrietLogMessage", int.class, String.class, String.class, new XC_MethodHook() {
                    @Override
